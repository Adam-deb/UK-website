      ...
      <main className={styles.main}>
        <section className={styles.terms}>
          <div className={styles.termsContainer}>
            ...
            <p>This privacy policy sets out how Decimal Factor Limited uses and protects any information that you give Decimal Factor when you use this website. Decimal Factor is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement. Decimal Factor Limited may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from May 2014.</p>
            ...
            <p>We may collect or ask for the following information:</p>
            <ul>
              <li>Your name</li>
              <li>Your contact details, including your full address, email address, and telephone number</li>
              <li>Demographic information such as your postcode, preferences, and interests</li>
              <li>Any other information relevant to the service we offer you or for customer surveys</li>
            </ul>

            <h2>What we do with the information we gather</h2>
            <p>Information about our customers is an important part of our business, and we are not in the business of selling it to others. We require this information to understand your needs and provide you with a better service, and in particular for the following reasons:</p>
            <ul>
              <li>Internal record keeping</li>
              <li>To correctly administer any order or products or services that you make</li>
            ...
            <h2>Security</h2>
            <p>We are committed to ensuring that your information is secure. In order to prevent unauthorized access or disclosure, we have put in place suitable physical, electronic, and managerial procedures to safeguard and secure the information we collect online. We will store and use your information only in accordance with the Data Protection Act 1998.</p>

            <h2>Use of Cookies</h2>
            <p>This website uses cookies to better the users&apos; experience while visiting the website. Where applicable, this website uses a cookie control system allowing the user on their first visit to the website to allow or disallow the use of cookies on their computer/device. This complies with recent legislation requirements for websites to obtain explicit consent from users before leaving behind or reading files such as cookies on a user&apos;s computer/device. This website uses traffic log cookies to identify which pages are being used. This helps us analyze data about web page traffic and improve our website in order to tailor it to customer needs. We only use this information for statistical analysis purposes and then the data is removed from the system. Overall, cookies help us provide you with a better website, by enabling us to monitor which pages you find useful and which you do not. A cookie in no way gives us access to your computer or any information about you, other than the data you choose to share with us.</p>
            <p>Cookies are small files saved to the users&apos; computer&apos;s hard drive that track, save, and store information about the users&apos; interactions and usage of the website. This allows the website, through its server, to provide the users with a tailored experience within this website. Users are advised that if they wish to deny the use and saving of cookies from this website on to their computer&apos;s hard drive they should take necessary steps within their web browser&apos;s security settings to block all cookies from this website and its external serving vendors.</p>
            <p>Other cookies may be stored to your computer&apos;s hard drive by external vendors when this website uses referral programs, sponsored links, or adverts. Such cookies are used for conversion and referral tracking and typically expire after 30 days, though some may take longer. No personal information is stored, saved, or collected. You can choose to accept or decline cookies. Most web browsers automatically accept cookies, but you can usually modify your browser setting to decline cookies if you prefer. This may prevent you from taking full advantage of the website.</p>
            ...
            <p>Users contacting this website and/or its owners do so at their own discretion and provide any such personal details requested at their own risk. Every effort has been made to ensure a safe and secure form to email submission process but advise users using such form to email processes that they do so at their own risk.</p>
